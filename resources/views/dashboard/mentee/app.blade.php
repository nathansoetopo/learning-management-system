...
<head>
    ...
    <title>@yield('title-mentee')</title>
    ...
    <script src="https://kit.fontawesome.com/d671fff6bd.js" crossorigin="anonymous"></script>
    @stack('menteeheadscript')
</head>

<body>
    <div id="app">
        @include('dashboard.mentee.component.sidebar')

        @yield('content-mentee')
    </div>
