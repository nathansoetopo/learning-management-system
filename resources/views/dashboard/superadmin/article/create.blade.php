...
@section('title-superadmin', 'Buat Blog Baru')
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Buat Blog</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{route('superadmin.blog.store')}}" class="row" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12">
                                <label for="basicInput">Judul Blog</label>
                                <input type="text" name="title" class="form-control" id="basicInput" required
                                    placeholder="Masukkan judul blog" value="{{ old('title') }}" autofocus>
                            </div>
