                                ...
                                <div class="col-md-6 pt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="link" class="form-control" id="basicInput"
                                            placeholder="Masukkan Link Meeting" autofocus>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 pt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" name="start_time" class="form-control" id="basicInput" required autofocus>
                                    </div>
                                </div>
                                <div class="col-md-6 pt-3">
                                    <div class="form-group">
                                        <label for="basicInput">Waktu Selesai</label>
                                        <input type="datetime-local" name="end_time" class="form-control" id="basicInput" required autofocus>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="capacity" class="form-control" id="basicInput" required
                                            placeholder="Masukkan Kapasitas Kelas" autofocus>
                                    </div>
                                </div>
                                <div class="col-md-12">
