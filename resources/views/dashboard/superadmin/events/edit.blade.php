        ...
        <div class="page-heading">
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Edit Event</h3>
                        <p class="text-subtitle text-muted">Update nama event, deskripsi dan thumbnail</p>
                    </div>
            ...
            <section class="section">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('superadmin.events.update', ['id' => $event->id])}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6 pt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="basicInput" required
                                            placeholder="Masukkan nama event" value="{{$event->name}}" autofocus>
                                    </div>
                            ...
                            <button class="btn btn-warning float-end" type="submit">Simpan</button>
                        </form>
                    </div>
                </div>
            </section>
