        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-5 col-lg-6 order-md-2" data-aos="fade-in" data-aos-delay="50">
                    ...
                    <!-- Image -->
                    <img src="{{asset('skola/assets/img/illustrations/illustration-1.png')}}" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0" alt="...">
                    ...
                    <div class="card border shadow p-2 sk-fade">
                        ...
                        <div class="card-zoom position-relative">
                            ...
                            <a href="./course-single-v1.html" class="card-img sk-thumbnail d-block">
                                <img class="rounded shadow-light-lg" src="{{asset('skola/assets/img/products/product-1.jpg')}}" alt="...">
                            </a>
                        ...
                        <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                            <a href="./instructors-single.html" class="d-block">
                                <div class="avatar avatar-xl badge-float position-absolute top-0 right-0 mt-n6 me-5 rounded-circle shadow border border-white border-w-lg">
                                    <img src="{{asset('skola/assets/img/avatars/avatar-1.jpg')}}" alt="..." class="avatar-img rounded-circle">
                                </div>
                            </a>

                            <!-- Preheading -->
                            <a href="{{asset('skola/course-single-v1.html')}}"><span class="mb-1 d-inline-block text-gray-800">Photography</span></a>
