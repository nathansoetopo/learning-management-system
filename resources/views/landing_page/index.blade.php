        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse z-index-lg" id="navbarCollapse">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarCourses" data-bs-toggle="dropdown"
                            href="#" aria-haspopup="true" aria-expanded="false">
                            Courses
                        </a>
                        <div class="dropdown-menu border-xl shadow-none dropdown-menu-lg"
                            aria-labelledby="navbarCourses">
                            <div class="row gx-0">
                                <div class="col-md-4">
                                    <!-- Heading -->
        ...
        <div class="position-absolute right-0 left-0 top-0 bottom-0">
            <div class="cs-parallax">
                <div class="cs-parallax-layer" data-depth="0.1">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-01.svg') }}"
                        alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.3">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-02.svg') }}"
                        alt="Layer">
                </div>
                ...
                <div class="cs-parallax-layer" data-depth="0.2">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-04.svg') }}"
                        alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.4">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-05.svg') }}"
                        alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.3">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-06.svg') }}"
                        alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.2">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-07.svg') }}"
                        alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.2">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-08.svg') }}"
                        alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.4">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-09.svg') }}"
                        alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.3">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-10.svg') }}"
                        alt="Layer">
                </div>
            </div>
        </div>
                    ...
                    <div class="card border shadow p-2 lift sk-fade">
                        ...
                        <div class="card-footer px-2 pb-0 pt-4">
                            ...
                            <a href="./blog-single.html" class="d-block">
                                <h5 class="line-clamp-2 h-48 h-lg-52">The Best Destinations to Begin Your Round the
                                    World Trip</h5>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md mb-5 mb-lg-0">
                    ...
                    <div class="card border shadow p-2 lift sk-fade">
                        ...
                        <div class="card-footer px-2 pb-0 pt-4">
                            ...
                            <!-- Heading -->
                            <a href="./blog-single.html" class="d-block">
                                <h5 class="line-clamp-2 h-48 h-lg-52">An Indigenous Anatolian Syllabic Script From
                                    3500 Years Ago</h5>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md mb-5 mb-lg-0">
                    ...
                    <div class="card border shadow p-2 lift sk-fade">
                        ...
                        <div class="card-footer px-2 pb-0 pt-4">
                            ...
                            <!-- Heading -->
                            <a href="./blog-single.html" class="d-block">
                                <h5 class="line-clamp-2 h-48 h-lg-52">10 Best Countries to Visit for Beginner
                                    Travelers</h5>
                            </a>
                        </div>
                    </div>
                            ...
                            <ul
                                ...
                                <li class="nav-item py-2 py-md-0 px-0 border-top-0">
                                    <a href="./terms-of-service.html"
                                        class="nav-link px-4 fw-normal text-gray-800">Site Map</a>
                                </li>
                                <li class="nav-item py-2 py-md-0 px-0 border-top-0">
                                    <a href="./terms-of-service.html"
                                ...
                                <li class="nav-item py-2 py-md-0 px-0 border-top-0">
                                    <a href="./terms-of-service.html"
                                        class="nav-link px-4 fw-normal text-gray-800">Web Use Policy</a>
                                </li>
                                <li class="nav-item py-2 py-md-0 px-0 border-top-0">
                                    <a href="./terms-of-service.html"
