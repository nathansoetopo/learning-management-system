...
<head>
    ...
    <link rel="stylesheet" href="{{asset('landing_page/css/themify-icons.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('landing_page/css/gijgo.css')}}">
                    ...
                    <div class="row align-items-center no-gutters">
                        ...
                        <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                            <div class="log_chat_area d-flex align-items-center">
                                ...
                                <a href="{{route('login')}}" class="text-white mr-4">
                                    <i class="flaticon-user"></i>
                                    <span>log in</span>
                                </a>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-6 col-md-6">
                        <div class="illastrator_png">
                            <img src="{{asset('landing_page')}}/img/banner/edu_ilastration.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6">
                            ...
                            <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="{{asset('landing_page')}}/img/courses/1.png" alt="">
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="{{asset('landing_page')}}/img/courses/2.png" alt="">
                                                </a>
                                            </div>
                                            <div class="courses_info">
                                                <span>Adobe XD</span>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="{{asset('landing_page')}}/img/courses/3.png" alt="">
                                                </a>
                                            </div>
                                            <div class="courses_info">
                                                <span>Wordpress</span>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="{{asset('landing_page')}}/img/courses/4.png" alt="">
                                                </a>
                                            </div>
                                            <div class="courses_info">
                                                <span>Photoshop</span>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            <div class="thumb">
                                                <img src="{{asset('landing_page')}}/img/courses/5.png" alt="">
                                            </div>
                                            <div class="courses_info">
                                                <span>UI/UX</span>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6">
                                        <div class="single_courses">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="{{asset('landing_page')}}/img/courses/6.png" alt="">
                                                </a>
                                            </div>
                                            <div class="courses_info">
                                                <span>Wordpress</span>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-4">
                    <div class="single_latest_blog">
                        <div class="thumb">
                            <img src="{{asset('landing_page')}}/img/latest_blog/1.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_latest_blog">
                        <div class="thumb">
                            <img src="{{asset('landing_page')}}/img/latest_blog/2.png" alt="">
                        </div>
                        <div class="content_blog">
                            <div class="date">
                                <p>12 Jun, 2019 in <a href="#">Design tips</a></p>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_latest_blog">
                        <div class="thumb">
                            <img src="{{asset('landing_page')}}/img/latest_blog/3.png" alt="">
                        </div>
                        <div class="content_blog">
                            <div class="date">
                                <p>12 Jun, 2019 in <a href="#">Design tips</a></p>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- JS here -->
    <script src="{{asset('landing_page/js/vendor/modernizr-3.5.0.min.js')}}"></script>
    <script src="{{asset('landing_page/js/vendor/jquery-1.12.4.min.js')}}"></script>
    ...
    <script src="{{asset('landing_page/js/isotope.pkgd.min.js')}}"></script>
    <script src="{{asset('landing_page/js/ajax-form.js')}}"></script>
    <script src="{{asset('landing_page/js/waypoints.min.js')}}"></script>
    <script src="{{asset('landing_page/js/jquery.counterup.min.js')}}"></script>
    <script src="{{asset('landing_page/js/imagesloaded.pkgd.min.js')}}"></script>
    <script src="{{asset('landing_page/js/scrollIt.js')}}"></script>
    <script src="{{asset('landing_page/js/jquery.scrollUp.min.js')}}"></script>
    <script src="{{asset('landing_page/js/wow.min.js')}}"></script>
    <script src="{{asset('landing_page/js/nice-select.min.js')}}"></script>
    ...
    <script src="{{asset('landing_page/js/gijgo.min.js')}}"></script>

    <!--contact js-->
    <script src="{{asset('landing_page/js/contact.js')}}"></script>
    <script src="{{asset('landing_page/js/jquery.ajaxchimp.min.j')}}s"></script>
    <script src="{{asset('landing_page/js/jquery.form.js')}}"></script>
    <script src="{{asset('landing_page/js/jquery.validate.min.js')}}"></script>
