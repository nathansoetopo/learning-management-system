...
@section('app-content')
        ...
        <div class="position-absolute right-0 left-0 top-0 bottom-0">
            <div class="cs-parallax">
                <div class="cs-parallax-layer" data-depth="0.1">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-01.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.3">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-02.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.2">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-02.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.2">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-04.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.4">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-05.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.3">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-06.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.2">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-07.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.2">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-08.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.4">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-09.svg') }}" alt="Layer">
                </div>
                <div class="cs-parallax-layer" data-depth="0.3">
                    <img class="img-fluid" src="{{ asset('skola/assets/img/parallax/layer-10.svg') }}" alt="Layer">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-5 col-lg-6 order-md-2" data-aos="fade-in" data-aos-delay="50">
                    ...
                    <!-- Image -->
                    <img src="{{ asset('skola/assets/img/illustrations/illustration-1.png') }}"
    ...
    <section class="pt-5 pb-9 py-md-11">
        ...
        <div class="container">
            <div class="row align-items-center mb-5" data-aos="fade-up">
                <div class="col-md mb-2 mb-md-0">
                    <h1 class="mb-1">Promo Master Class</h1>
                    <p class="font-size-lg text-capitalize">Discover your perfect program in our courses.</p>
                </div>
            </div>
            ...
            <div class="mx-n4"
                data-flickity='{"pageDots": true, "prevNextButtons": true, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}'>
                @foreach ($vouchers_master_class as $masterClass)
                    <div class="col-12 col-md-6 col-xl-4 pb-4 pb-md-7" data-aos="fade-up" data-aos-delay="50"
                        style="padding-right:15px;padding-left:15px;">
                        <!-- Card -->
                        <div class="card border shadow p-2 sk-fade">
                            ...
                            <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                <!-- Preheading -->
                                {{-- <a href="{{ asset('skola/course-single-v1.html') }}"><span class="mb-1 d-inline-block text-gray-800">{{ $masterClass->event->name }}</span></a> --}}
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="row mx-n2 align-items-end mh-50">
                                        <p class="text-decoration-line-through">Rp. @money($masterClass->price)</p>
                                        ...
                                        <div class="col-auto px-2 text-right">
                                            <ins class="h4 mb-0 d-block mb-lg-n1">Rp. {{rupiah(getSimulationDiscountVoucher($masterClass->voucher_discount, $masterClass->voucher_nominal, $masterClass->price))}}</ins>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12 col-md-6 col-xl-4 py-md-7 py-3" data-aos="fade-up" data-aos-delay="50"
                    ...
                    <div class="card border shadow p-6 lift-md">
                        ...
                        <div class="card-footer px-0 pb-0">
                            <p class="mb-0 text-capitalize">“ I believe in lifelong learning and Skola is a great
                                place to learn from experts. I've learned a lot and recommend it to all my friends “</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row row-cols-3 row-cols-md-5 text-center w-xl-80 mx-xl-auto justify-content-center align-items-center"
                ...
                <div class="col-md mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="50">
                    <div class="mw-100p mx-auto">
                        ...
                        <svg viewBox="0 0 100 34" xmlns="http://www.w3.org/2000/svg">
                            <path fill="#000000"
                                d="M15,19.1c-0.1,0-0.2,0.1-0.3,0.1c-0.2,0-0.6-0.9-0.7-1.5c-0.5,0.5-1.4,1.5-3.2,1.5c-2.3,0-3.7-1.5-3.7-3.8
                ...
                <div class="col-md mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                    <div class="mw-100p mx-auto">
                        ...
                        <svg viewBox="0 0 100 34" xmlns="http://www.w3.org/2000/svg">
                            <path fill="#FF5A5F"
                                d="M31.5,23.4c-1-1.1-1.5-2.5-1.5-4.2c0-1.7,0.5-3.1,1.5-4.1c1-1.1,2.2-1.6,3.7-1.6c1.5,0,2.7,0.6,3.4,1.9v-1.7
                    ...
                    <div class="mw-100p mx-auto">
                        ...
                        <svg viewBox="0 0 100 34" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <g>
                                    <path fill="#E43D91"
                                        d="M15.2,27c-1,0-1.8-0.9-1.6-2l2.8-16.6C16.6,7.6,17.3,7,18.1,7c1,0,1.8,0.9,1.6,2l-2.8,16.6
                        			C16.7,26.4,16,27,15.2,27L15.2,27z" />
                                    <path fill="#E43D91"
                                        d="M15.2,25l2.8-16.6c0.1-0.5,0.4-0.9,0.8-1.2C18.7,7.1,18.4,7,18.1,7c-0.8,0-1.5,0.6-1.6,1.4L13.6,25
                        			c-0.2,1,0.6,2,1.6,2c0.3,0,0.6-0.1,0.8-0.2C15.5,26.4,15.1,25.8,15.2,25z" />
                                </g>
                                <g>
                                    <path fill="#009ADD"
                                        d="M22.9,27c-1,0-1.8-0.9-1.6-2l2.8-16.6C24.3,7.6,25,7,25.8,7c1,0,1.8,0.9,1.6,2l-2.8,16.6
                        			C24.4,26.4,23.7,27,22.9,27L22.9,27z" />
                                    <path fill="#009ADD"
                                        d="M22.9,25l2.8-16.6c0.1-0.5,0.4-0.9,0.8-1.2C26.3,7.1,26.1,7,25.8,7c-0.8,0-1.5,0.6-1.6,1.4L21.3,25
                        			c-0.2,1,0.6,2,1.6,2c0.3,0,0.6-0.1,0.8-0.2C23.1,26.5,22.8,25.8,22.9,25L22.9,25z" />
                                </g>
                                <g>
                                    <path fill="#FEDE3A"
                                        d="M11.4,12.8c0.1-0.8,0.8-1.4,1.7-1.4h16.3c1,0,1.8,1,1.7,2c-0.1,0.8-0.8,1.4-1.7,1.4H13
                                ...
                                <g>
                                    <path fill="#A2F2B3"
                                        d="M11,20.6c0.1-0.8,0.8-1.4,1.7-1.4H29c1,0,1.8,1,1.7,2c-0.1,0.8-0.8,1.4-1.7,1.4H12.7
                        			C11.6,22.6,10.8,21.7,11,20.6z" />
                                    <path fill="#A2F2B3"
                                        d="M29,20.9H12.7c-0.6,0-1.2-0.3-1.5-0.9c-0.1,0.2-0.2,0.4-0.2,0.6c-0.2,1,0.6,2,1.7,2H29c0.8,0,1.5-0.6,1.7-1.4
                        			c0.1-0.4,0-0.8-0.2-1.1C30.1,20.6,29.6,20.9,29,20.9L29,20.9z" />
                                </g>
                            </g>
                            <path stroke="#000000" stroke-miterlimit="10"
                                d="M35.5,24.8c-0.3-0.2-0.5-0.5-0.5-0.9c0-0.3,0.1-0.5,0.3-0.8c0.2-0.2,0.5-0.3,0.8-0.3c0.2,0,0.3,0,0.5,0.1
                ...
                <div class="col-md mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="250">
                    <div class="mw-100p mx-auto">
                        ...
                        <svg viewBox="0 0 100 34" xmlns="http://www.w3.org/2000/svg">
                            <path fill="#1DD05D"
                                d="M29.3,17c0,6.6-5.4,12-12.1,12C10.4,29,5,23.6,5,17c0-6.6,5.4-12,12.1-12C23.8,5,29.3,10.4,29.3,17z M17.1,11.5
                        ...
                        <div class="card border shadow p-2 lift">
                            <div class="row gx-0">
                                ...
                                <a href="./event-single.html" class="col-auto d-block mw-md-152"
                                    ...
                                    <img class="img-fluid rounded shadow-light-lg h-100 o-f-c" src="{{ $soon->image }}"
                                        alt="...">
                                </a>
                            ...
                            <div class="card-zoom position-relative" style="max-width: 250px;">
                                ...
                                <a href="./instructors-single.html"
                                    class="card-img sk-thumbnail img-ratio-4 card-hover-overlay d-block"><img
                                        class="rounded shadow-light-lg img-fluid" src="{{ $mentor->avatar }}"
                                        alt="..."></a>
                            </div>
    ...
    <section class="bg-white py-5 py-md-11">
        <div class="container">
            <div class="row align-items-end mb-4 mb-md-7" data-aos="fade-up">
                ...
                <div class="col-md-auto">
                    <a href="{{route('landing-page.blog.index')}}" class="d-flex align-items-center fw-medium">
                        Browse All
                        <div class="ms-2 d-flex">
                            <!-- Icon -->
                            <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                ...
                @foreach ($blogs as $blog)
                    <div class="col-md mb-5 mb-lg-0">
                        ...
                        <div class="card border shadow p-2 lift sk-fade">
                            <!-- Image -->
                            <div class="card-zoom position-relative">
                                <a href="{{route('landing-page.blog.show', ['id' => $blog->id])}}" class="card-img d-block sk-thumbnail img-ratio-3"><img
                                        class="rounded shadow-light-lg img-fluid"
                                ...
                                <a href="{{route('landing-page.blog.show', ['id' => $blog->id])}}"
                                    ...
                                    <span class="text-white fw-normal font-size-sm">{{$blog->categories->first()->title}}</span>
                                </a>
                            </div>
                            ...
                            <div class="card-footer px-2 pb-0 pt-4">
                                <ul class="nav mx-n3 mb-3">
                                    <li class="nav-item px-3">
                                        <a href="{{route('landing-page.blog.show', ['id' => $blog->id])}}" class="d-flex align-items-center text-gray-800">
                                            ...
                                            <div class="font-size-sm">{{day($blog->created_at)}}</div>
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <a href="./blog-single.html" class="d-block">
                                    <h5 class="line-clamp-2 h-48 h-lg-52">{{$blog->title}}</h5>
                                </a>
                            </div>
                        </div>
                    </div>
